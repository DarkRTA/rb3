...
class ProjectConfig:
    def __init__(self) -> None:
        ...
        self.asm_dir: Optional[Path] = Path("asm")  # Override incomplete objects (for modding)
        ...
        self.rel_empty_file: Optional[str] = None  # Object name for generating empty RELs
        self.shift_jis = True  # Convert source files from UTF-8 to Shift JIS automatically
        self.reconfig_deps: Optional[List[Path]] = None  # Additional re-configuration dependency files
        ...
        self.progress_each_module: bool = True  # Include individual modules, disable for large numbers of modules
