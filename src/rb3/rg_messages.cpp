...
StringStrummedMsg::StringStrummedMsg(int i1, int i2, int i3, int i4)
	: Message(
		GetStringStrummedSymbol(), DataNode(i1), DataNode(i2), DataNode(i3),
		DataNode(i4))
{
}
...
RGAccelerometerMsg::RGAccelerometerMsg(int i1, int i2, int i3, int i4)
	: Message(
		GetRGAccelerometerSymbol(), DataNode(i1), DataNode(i2), DataNode(i3),
		DataNode(i4))
{
}
...
RGFretButtonDownMsg::RGFretButtonDownMsg(int i1, int i2, int i3)
	: Message(
		GetRGFretButtonDownSymbol(), DataNode(i1), DataNode(i2), DataNode(i3))
{
}
...
RGFretButtonUpMsg::RGFretButtonUpMsg(int i1, int i2, int i3)
	: Message(
		GetRGFretButtonUpSymbol(), DataNode(i1), DataNode(i2), DataNode(i3))
{
}
