...
extern "C" UnknownJsonConverterMember *
fn_800A6A38(UnknownJsonConverterMember *, Dummy *);
...
extern "C" UnknownJsonConverterMember *
fn_800A67E8(UnknownJsonConverterMember *, int);
...
extern "C" UnknownJsonConverterMember *
fn_800A6868(UnknownJsonConverterMember *, int);
...
fn_800A6868(UnknownJsonConverterMember *, int);
extern "C" void
fn_800A6940(UnknownJsonConverterMember *, JsonObject **, unsigned short);
extern "C" UnknownJsonConverterMember *
fn_800A68E8(UnknownJsonConverterMember *, int);
...
extern "C" UnknownJsonConverterMember *
fn_800A6A78(UnknownJsonConverterMember *, Dummy *);

// fn_800A6A38
UnknownJsonConverterMember *
fn_800A6A38(UnknownJsonConverterMember *mem, Dummy *d)
{
	Dummy j;
	fn_800A6A78(mem, &j);
	return mem;
...
extern "C" UnknownJsonConverterMember *
fn_800A6AA8(UnknownJsonConverterMember *, Dummy *);

// fn_800A6A78
UnknownJsonConverterMember *
fn_800A6A78(UnknownJsonConverterMember *mem, Dummy *d)
{
	fn_800A6AA8(mem, d);
	return mem;
}
...
extern "C" void
fn_800A6AE8(UnknownJsonConverterMember *, Dummy *, JsonObject **);

// fn_800A6AA8
UnknownJsonConverterMember *
fn_800A6AA8(UnknownJsonConverterMember *mem, Dummy *d)
{
...
JsonObject *fn_800A6E20(JsonConverter *jc, JsonArray *ja, int i)
{
	if (i >= 0)
		ja->Length();
	JsonObject *obj = new JsonObject();
	obj->json_object_struct =
		json_object_array_get_idx(ja->GetJsonObjectStruct(), i);
	fn_800A6EA8(jc, obj);
	return obj;
}
...
extern void fn_800A6FC8(
	UnknownJsonConverterMember *, JsonObject **, JsonObject **, char *, int,
	int);
