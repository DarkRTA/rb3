...
// void Multiply(const Vector3& v, const Hmx::Matrix3& mtx, Vector3& dst){
	
// }

// https://decomp.me/scratch/hW3UZ
...
//         // Multiply mtx.row3
//         psq_l     mtxXY, Hmx::Matrix3.row3.x(mtx), 0, 0
//         psq_l     mtxZ,  Hmx::Matrix3.row3.z(mtx), 1, 0
//         ps_muls1  dstXY, mtxXY, vecYZ // mtx.row3.xy * vec.z
//         ps_muls1  dstZ,  mtxZ,  vecYZ // mtx.row3.z  * vec.z

//         // Multiply mtx.row2
//         psq_l     mtxXY, Hmx::Matrix3.row2.x(mtx), 0, 0
//         psq_l     mtxZ,  Hmx::Matrix3.row2.z(mtx), 1, 0
//         ps_madds0 dstXY, mtxXY, vecYZ, dstXY // mtx.row2.xy * vec.y
//         ps_madds0 dstZ,  mtxZ,  vecYZ, dstZ  // mtx.row2.z  * vec.y

//         // Multiply mtx.row1
//         psq_l     mtxXY, Hmx::Matrix3.row1.x(mtx), 0, 0
//         psq_l     mtxZ,  Hmx::Matrix3.row1.z(mtx), 1, 0
