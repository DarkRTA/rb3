...
Stats::Stats()
    : mHitCount(0), mMissCount(0), m0x08(0), m0x0c(0), mPersistentStreak(0),
      ...
      mTripleHarmonyPhraseCount(0), m0x5c(0), m0x60(0), m0x64(0), m0x68(0), m0x6c(0),
      mAccuracy(0), m0x8c(0), mSolo(0), mOverdrive(0), mSustain(0), mScoreStreak(0),
      mBandContribution(0), mCodaPoints(0), mHasCoda(0), mHasSolos(0), mTambourine(0),
      mHarmony(0), mFullCombo(0), mNoScorePercent(0), mHitStreaks(3), mMissStreaks(3),
      mFailurePoints(3, -1.0f), mSavedPoints(3, -1.0f), mPlayersSaved(0),
