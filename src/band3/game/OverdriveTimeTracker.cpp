...
OverdriveTimeTracker::OverdriveTimeTracker(TrackerSource* src, TrackerBandDisplay& banddisp, TrackerBroadcastDisplay& bcdisp) : Tracker(src, banddisp, bcdisp),
    unk58(0), unk5c(0), unk60(0), unk64(-1.0f), unk68(1), unk6c(0) {
