...
ClosetPanel::ClosetPanel()
    : mClosetMgr(0), mCameraManager(0), mPortraitRenderer(0), mPortraitState(0) {}
...
bool ClosetPanel::Exiting() const { return UIPanel::Exiting() || mPortraitState != 0; }
...
CamShot *ClosetPanel::GetCurrentShot() { return mCameraManager->mCurrentShot; }
...
void ClosetPanel::GotoArtMakerShot() {
    ...
    if (shot)
        mCameraManager->ForceCameraShot(shot);
}
