...
public:
    ...
    bool
    IsComparisonConditionMet(const TourPropertyCollection &, const DataArray *) const;
    ...
    bool
    IsGreaterEqualConditionMet(const TourPropertyCollection &, const DataArray *) const;
