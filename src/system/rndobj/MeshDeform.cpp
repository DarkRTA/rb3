...
BinStream& operator>>(BinStream& bs, RndMeshDeform::BoneDesc&) {
...
BEGIN_LOADS(RndMeshDeform)
    ...
    if (gRev != 0) mVerts.Load(bs);
    bs >> mMeshInverse;
    // how NOT to check against the identity matrix
    mSkipInverse = (0 == mMeshInverse.v.x && 0 == mMeshInverse.v.y && 0 == mMeshInverse.v.z 
                    ...
                    && 0 == mMeshInverse.m.z.x && 0 == mMeshInverse.m.z.y && 1 == mMeshInverse.m.z.z);
END_LOADS
