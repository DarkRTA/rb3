...
public:
    ...
    /** Handler to (presumably) sort all instances according to supplied X/Y/Z
     * coordinates. I say "presumably" because this handler actually will fail in debug
     * and return 0 in retail.
     * @param [in] arr The supplied DataArray.
     * Expected DataArray contents:
     *     Nodes 2-4: the desired X/Y/Z coordinates.
     ...
     * I say "presumably" because this handler actually will fail in debug and return 0 in
     * retail. Example usage: {$this random_xfms}
     */
