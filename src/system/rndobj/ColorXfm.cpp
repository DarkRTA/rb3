...
void RndColorXfm::AdjustLevels(){
    Vector3 v50(mLevelInHi.red - mLevelInLo.red, mLevelInHi.green - mLevelInLo.green, mLevelInHi.blue - mLevelInLo.blue);
    float f1 = 0;
    if(v50.z != 0){
    ...
    float f2 = 0;
    if(v50.y != 0){
        f2 = (mLevelOutHi.green - mLevelOutLo.green) / (mLevelInHi.green - mLevelInLo.green);
    }
    float f3 = 0;
    if(v50.x != 0){
    ...
    Vector3 v68(v5c.x * -mLevelInLo.red + mLevelOutLo.red,
