...
public:
    ...
    static class ObjectDir *
    LoadObjects(const FilePath &, Loader::Callback *, BinStream *);
    static void SetCacheMode(bool);
    static Symbol GetDirClass(const char *);
    static const char *CachedPath(const char *, bool);
    static Loader *New(const FilePath &f, LoaderPos l) {
        return new DirLoader(f, l, NULL, NULL, NULL, false);
    }
