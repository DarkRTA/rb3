...
BinkReader::BinkReader(File* f, StandardStream* s) : mFile(f), mStream(s), mDecodeTrack(0), mSamplesReady(0),
    mSampleCurrent(0), mSamplesJump(0), mState(kOpenBink), mHeap(sHeap) {
    mPlaying++;
    BinkInit();
