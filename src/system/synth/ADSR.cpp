...
const float gLinInc[128] = { 0.000049999999f,
                             0.000059999998f,
                             0.00007f,
                             0.00009f,
                             0.000099999997f,
...
const float gLinDec[128] = { 0.000039999999f,
                             0.000049999999f,
                             0.000059999998f,
                             0.00007f,
                             0.00009f,
...
ADSR::ADSR()
    : mAttackRate(0.001f), mDecayRate(0.0001f), mSustainRate(0.001f),
      mReleaseRate(0.005f), mSustainLevel(1.0f), mAttackMode(Ps2ADSR::kAttackExp),
      mSustainMode(Ps2ADSR::kSustainLinInc), mReleaseMode(Ps2ADSR::kReleaseLinear),
      mPacked(), mSynced(0) {}
