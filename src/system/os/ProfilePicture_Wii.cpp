...
ProfilePicture::ProfilePicture(int padnum, Hmx::Object *obj)
    : mState(kIdle), mUserID(), mUserPicture(0), mPadNum(padnum), mCallback(obj) {}

void ProfilePicture::FetchUserData() { MILO_ASSERT(mState == kFetchingUserData, 0x18); }
