...
int LocalUser::GetPadNum() const { return JoypadGetUsersPadNum((LocalUser *)this); }

int LocalUser::GetPadType() const { return GetWiiJoypadType(GetPadNum()); }

void LocalUser::UpdateOnlineID() {
    mHasOnlineID = ThePlatformMgr.IsUserSignedIn((LocalUser *)this);
    mOnlineID->SetPrincipalID(TheWiiProfileMgr.GetIdForIndex(
...
bool LocalUser::IsGuest() const { return ThePlatformMgr.IsUserAGuest((LocalUser *)this); }
