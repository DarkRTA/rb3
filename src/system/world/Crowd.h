...
public:
    ...
    public:
        ...
        float mDensity; // 0x10
        /** "Collision radius of the character - characters won't be placed within this
         * range" */
        float mRadius; // 0x14
    ...
    public:
        ...
        // the RB3 dump says mDef is a member - would it be easier to make CharDef a
        // superclass of CharData?
        CharDef mDef; // 0x0
    ...
    DELETE_OVERLOAD;
    NEW_OBJ(WorldCrowd)
    static void Init() { REGISTER_OBJ_FACTORY(WorldCrowd) }
    ...
    /** "Shows only the 3D crowd, but ONLY in Milo so you can more easily distinguish them
     * from the 2d crowd" */
