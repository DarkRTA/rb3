...
BEGIN_PROPSYNCS(Spotlight)
    ...
    SYNC_PROP_SET(flare_visibility_test, mFlareVisibilityTest == 0, SetFlareIsBillboard(_val.Int() == 0))
    ...
    SYNC_PROP_SET(color, Color().Opaque(), SetColor(_val.Int())) // there are color32 inlines here - fix!
