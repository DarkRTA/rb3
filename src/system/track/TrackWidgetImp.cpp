...
MultiMeshWidgetImp::MultiMeshWidgetImp(
    const ObjPtrList<RndMesh, ObjectDir> &meshlist, bool b
)
...
// CharWidgetImp::CharWidgetImp(RndFont* f, RndText* t, int i1, int i2,
// RndText::Alignment, Hmx::Color32, Hmx::Color32, bool)
