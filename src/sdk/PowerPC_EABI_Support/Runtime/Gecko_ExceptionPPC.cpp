...
static inline void __asdf(CatchInfo *catchinfo) {
    if (catchinfo) {
        try {
            throw;
...
// https://github.com/xbret/xenoblade/blob/main/libs/PowerPC_EABI_Support/src/Runtime/Gecko_ExceptionPPC.cp#L539
...
static void ExPPC_HandleUnexpected(
