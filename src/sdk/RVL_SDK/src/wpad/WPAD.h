...
typedef struct /* possibly untagged, like kpad */
{
    ...
    long signed at_0x038[2]; // size 0x008, offset 0x038	/* unknown */ //
                             // WPADResult[2]? see __wpadGetGameInfo
    ...
    char unsigned unk_0xbbc; // size 0x001, offset 0xbbc	/* unknown */ // related to
                             // VSM
