...
typedef struct /* possibly untagged, like kpad */
{
    ...
    u8 syncSkipChecks; // size 0x001, offset 0x6e7	// maybe? it also adds some checks
                       // though???
    s8 syncLoopNum; // size 0x001, offset 0x6e8	// implied by usage (see
                    // __wudSyncPrepareSearch) and location of stripped symbol
                    // WUDSetSyncLoopNum near other members
    WUDSyncType syncType; // size 0x001, offset 0x6e9

    u8 connectable; // size 0x001, offset 0x6ea
    u8 discoverable; // size 0x001, offset 0x6eb	// implied by usage and
                     // WUDGetDiscoverable being right before WUDGetConnectable
    ...
    BD_ADDR hostAddr; // size 0x006, offset 0x702	// name comes from stripped symbol
                      // _WUDGetHostAddr
    ...
    s8 syncRssi; // size 0x001, offset 0x70b	// implied by usage and stripped symbols
                 // _WUD[GS]etSyncRssi
