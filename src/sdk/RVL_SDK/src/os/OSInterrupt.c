...
static u32 SetInterruptMask(u32 type, u32 mask) {
    ...
    case OS_INTR_EXI_0_EXT:
        exi0Mask = EXI_CHAN_CTRL[EXI_CHAN_0].cr;
        ...
        EXI_CHAN_CTRL[EXI_CHAN_0].cr = exi0Mask;
    ...
    case OS_INTR_EXI_1_EXT:
        exi1Mask = EXI_CHAN_CTRL[EXI_CHAN_1].cr;
        ...
        EXI_CHAN_CTRL[EXI_CHAN_1].cr = exi1Mask;
    ...
    case OS_INTR_EXI_2_TC:
        exi2Mask = EXI_CHAN_CTRL[EXI_CHAN_2].cr;
        ...
        EXI_CHAN_CTRL[EXI_CHAN_2].cr = exi2Mask;
...
void __OSDispatchInterrupt(u8 intr, OSContext* ctx) {
    ...
    if (intsr & PI_INTSR_EXI) {
        exi0Cause = EXI_CHAN_CTRL[EXI_CHAN_0].cr;
        ...
        exi1Cause = EXI_CHAN_CTRL[EXI_CHAN_1].cr;
        ...
        exi2Cause = EXI_CHAN_CTRL[EXI_CHAN_2].cr;
